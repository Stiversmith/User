...
//  Lesson 24
//
//  Created by Aliaksandr Yashchuk on 10/11/23.
//
...
class UsersTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toMapViewController", sender: CLLocationCoordinate2D(latitude: latitude, longitude: longitude))
    }
